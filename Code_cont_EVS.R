...
get_eee1=function(data,Xname="X",Xsname="Xs",Yname="Y",Mname="M",Wname="W",Zname="W",Iname="I") {
  ...
  Ai=solve(A+diag(1e-10,dim(A)[1]),tol = 1e-26)
  covP=(Ai %*% B %*% t(Ai))
...
#    X          M        Y          Xs          W I
# 1 NA 0.05362556 1.795859  0.08359966 -0.2767878 0
# 2 NA 0.84814880 3.888258  0.31246567  1.7258482 0
# 3 NA 0.83600551 2.836692  0.06888602  0.3009470 0
# 4 NA 1.08110498 2.379830  2.03045968  0.6964916 0
# 5 NA 0.78280199 2.769351 -1.35051705 -0.2422349 0
# 6 NA 2.41550386 3.408872  2.68147596  0.3208582 0
